  ...
  const toggleRecord = useCallback(async () => {
    if (isRecording) {
      ...
      try {
        ...
        const stream = svWrap?.captureStream ? svWrap.captureStream(30) : await navigator.mediaDevices.getDisplayMedia({ video: true });
        ...
        rec.onstop = () => {
          ...
          a.href = url; a.download = `street-journey-${Date.now()}.webm`; a.click();
